...
// registered-but-unsafe Claude/Codex adapters must NOT be activatable by
...
describe("engine enablement gate (P0 security)", () => {
  test("safe default: chat/opencode/mock/daytona ON; claude/codex/claude-sdk OFF", () => {
    ...
    // The gated engines are closed unless explicitly enabled.
