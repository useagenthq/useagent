...
- **memory_search(query, limit?)** - recall relevant facts about this user/organization. Returns cited results with stable refs (tencent:l0:<id> / tencent:l1:<id> / tencent:l2:<id> / tencent:l3:<id>) and their scope/layer. A just-finished capture may instead have a temporary useagent:provisional:<id> ref; use its content now, but wait for delivery and search again before memory_correct or memory_forget.
