...
description: Learn how canonical events, retained native frames, and two server-sent event streams carry durable run state to the browser.
sidebar:
  order: 3
---
...
what lets Codex, Claude Code, OpenCode, and Pi render through one UI contract: each
