...
For a supported gated tool, the session timeline pauses on the approval card and
resumes only after the one-shot capability is consumed. Slack delivery of
approval cards is not an approval surface; resolve the request in the session
timeline.
