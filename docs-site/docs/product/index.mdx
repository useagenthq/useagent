...
<CardGroup cols={3}>
  ...
  <Card title="Manage everything" icon="library">
    Hubs for bots, skills, playbooks, knowledge, wiki, memory, artifacts,
    automations, secrets, and settings.
  </Card>
</CardGroup>
...
| `/bots`, `/bots/:id` | Named agent presets, home threads, routines, and handoff history. |
