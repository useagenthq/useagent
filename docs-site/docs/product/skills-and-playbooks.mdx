...
<CardGroup cols={2}>
  <Card title="Skills" icon="wand-sparkles" href="/skills">
    Versioned, reusable instructions, selected semantically and activated by exact
    id for a task.
  </Card>
  <Card title="Playbooks" icon="book-open-text" href="/playbooks">
...
import `SKILL.md` files from a repository with one click, and an optional hourly
resync keeps the catalog current.
