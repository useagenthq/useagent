...
/**
 * Human display label for a tool's provider/server id. "useAgent-knowledge" is the
 * knowledge+capability gateway's WIRE name (backend SERVER_INFO, engine mcp
 * registration, `mcp__useAgent-knowledge__` permission prefixes, retained sandbox
