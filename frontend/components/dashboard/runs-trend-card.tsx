      ...
      <div className='flex items-start justify-between'>
        <div className='flex flex-col gap-0.5'>
          ...
          <div className='flex items-center gap-2'>
            <p className='text-headline-medium font-semibold tracking-[-0.1px] tabular-nums text-text-primary'>{tokensLabel}</p>
        ...
        <ResponsiveContainer width='100%' height='100%'>
          <ComposedChart data={data} margin={{ top: 8, right: 6, bottom: 0, left: 0 }}>
            ...
            <Line
              ...
              strokeWidth={2.5}
              dot={false}
              activeDot={{ r: 4, fill: '#519DFA', stroke: 'var(--color-background-primary-default)', strokeWidth: 2 }}
              isAnimationActive
              animationDuration={450}
            />
          </ComposedChart>
