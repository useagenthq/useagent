...
/**
 * Textarea form control. `Root` renders a bordered, non-auto-resizing textarea
 * (controlled via value/onChange). `simple` collapses the outer container to a
 * single bordered box; the default variant adds a footer slot (children) and a
 * manual resize handle. `CharCounter` renders an optional current/max counter.
 */
