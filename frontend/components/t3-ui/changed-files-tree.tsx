...
//   locally (T3WorkedForFold pattern) and the diff affordances collapse to ONE
 ...
 */
export const T3ChangedFilesCard = memo(function T3ChangedFilesCard(props: {
...
export const T3ChangedFilesTree = memo(function T3ChangedFilesTree(props: {
  files: ReadonlyArray<T3ChangedFile>;
          ...
          >
            ...
            {hasNonZeroStat(node.stat) && (
              <span className="ml-auto shrink-0 font-mono text-[10px] tabular-nums">
                <T3DiffStatLabel additions={node.stat.additions} deletions={node.stat.deletions} />
              </span>
            )}
          </button>
          {isExpanded && (
  ...
  return (
    <div data-t3-ui="changed-files-tree" className="space-y-0.5">
