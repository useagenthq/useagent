...
// already-ported T3WorkEntryRow. Tokens are AlignUI semantic.
 ...
 */
export const T3WorkedForFold = memo(function T3WorkedForFold({
  nodes,
  workspaceRoot,
    ...
    >
      ...
      {expanded && (
        <div className="mt-1 space-y-px">
          {entries.map((entry) => (
            <T3WorkEntryRow key={entry.id} entry={entry} workspaceRoot={workspaceRoot} />
          ))}
        </div>
      )}
    </section>
