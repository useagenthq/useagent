...
import { T3WorkedForFold, workedForDuration, workedForLabel } from "./worked-for-fold";
...
test("renders nothing for an empty burst", () => {
  expect(renderToStaticMarkup(<T3WorkedForFold nodes={[]} />)).toBe("");
});
