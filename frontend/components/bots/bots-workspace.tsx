...
/**
 * The selected bot's thread. On md and up the roster is the shell's second
 * sidebar column (see shell/bots-panel.tsx), so this pane is the whole page.
  ...
  return (
    <div className="flex h-full min-h-0">
      <BotsRoster
        ...
        className={selected ? "hidden" : "flex md:hidden"}
      />
