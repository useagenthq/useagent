      ...
      <div className='mx-auto max-w-4xl px-6'>
        <div className='animate-ai-fade-up flex flex-col gap-1 py-10'>
          ...
          <p className='text-paragraph-md text-text-sub-600'>
            Every vendored AlignUI primitive this app composes, wired to the
            Skynet brand layer. Toggle the theme from any page to confirm both
            render.
          </p>
        </div>
          ...
          <div className='max-w-sm'>
            <SegmentedControl.Root defaultValue='all'>
              <SegmentedControl.List>
                ...
                <SegmentedControl.Trigger value='archived'>
                  Archived
                </SegmentedControl.Trigger>
              </SegmentedControl.List>
        ...
        <Section label='Thinking orb — engine-driven agent loader'>
          <p className='text-paragraph-sm text-text-sub-600'>
            ...
            <code>searching</code> preset for the session boot phase. Grayscale-
            by-depth, so it tracks the theme with no token mapping.
          </p>
          <div className='flex flex-wrap items-end gap-8'>
            {(['working', 'searching', 'shaping'] as OrbState[]).map((state) => (
              <div key={state} className='flex flex-col items-center gap-2'>
                <ThinkingOrb state={state} size={64} />
                <span className='text-mono-label text-text-soft-400 capitalize'>
                  {state}
                </span>
              </div>
            ))}
        ...
        <Section label='AI kit · Approval card'>
          <ApprovalCard
            ...
            options={[
              { label: 'Approve for this run', detail: 'Reach the npm registry until the run finishes' },
        ...
        <Section label='AI kit · Filter table'>
          <FilterTable
            ...
            rows={[
              { name: 'Restock mango sorbet', date: 'Dec 03', statusKey: 'todo', advisor: 'Mango Moon Gelato' },
              { name: 'Churn black sesame', date: 'Sep 22', statusKey: 'progress', advisor: 'Kumo Creamery' },
              { name: 'Print summer menu', date: 'Jan 02', statusKey: 'todo', advisor: 'Coral Coast Sorbet' },
              { name: 'Taste-test batch 42', date: 'Nov 08', statusKey: 'progress', advisor: 'Maple Orbit' },
              { name: 'Order waffle cones', date: 'Apr 14', statusKey: 'done', advisor: 'Aurora Scoops' },
            ]}
          />
        </Section>
