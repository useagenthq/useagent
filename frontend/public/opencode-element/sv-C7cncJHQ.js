...
Kod: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "OpenCode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL-servern avslutades innan den blev felfri (kod={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Tidsgränsen för hälsokontrollen av sidoprocessen för {{distro}} överskreds efter {{timeout}} ms",
  ...
  "provider.connect.apiKey.description": "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i OpenCode.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.opencodeZen.line2": "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  ...
  "provider.connect.oauth.code.visit.suffix": " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i OpenCode.",
  ...
  "dialog.server.default.description": "Anslut till den här servern vid appstart istället för att starta en lokal server. Kräver omstart.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Subsystem for Linux) krävs innan OpenCode kan lägga till en WSL-server",
  ...
  "wsl.onboarding.windowsRestartRequired": "Starta om Windows för att slutföra installationen av WSL och öppna sedan OpenCode igen.",
  ...
  "help.tabs.sessions": "Starta en ny session på en flik eller öppna en befintlig session från något av dina projekt. Öppna en ny flik när du påbörjar något nytt och stäng den när du är klar.",
  "help.tabs.organize": "Genom att hålla några flikar öppna blir det enklare att ordna dina aktiva sessioner. Byt namn på flikarna till något du kommer ihåg om du tänker behålla dem.",
  "help.tabs.home": "Du hittar alla dina sessioner och projekt på den nya hemskärmen. När du väljer en session öppnas den på en flik.",
  "help.tabs.persistence": "När du öppnar appen igen är dina flikar fortfarande öppna.",
  "help.tabs.worktrees": "Den nya designen stöder inte Git Worktrees ännu, men stöd kommer snart. Om du föredrar att fortsätta använda den tidigare layouten kan du därför växla mellan layouterna i Inställningar. Tänk bara på att den nya layouten blir permanent om några veckor.",
  ...
  "error.dev.rootNotFound": "Rotelementet hittades inte. Har du glömt att lägga till det i din index.html? Eller kanske id-attributet är felstavat?",
...
{{body}}`,
  ...
  "error.chain.providerInitFailed": 'Det gick inte att initiera leverantören "{{provider}}". Kontrollera autentiseringsuppgifter och konfiguration.',
...
{{message}}`,
  ...
  "session.review.noSnapshot": "Spårning av ögonblicksbilder är inaktiverad i konfigurationen, så sessionsändringar är inte tillgängliga",
  ...
  "session.share.popover.description.shared": "Denna session är offentlig på webben. Den är tillgänglig för alla med länken.",
  "session.share.popover.description.unshared": "Dela sessionen offentligt på webben. Den kommer att vara tillgänglig för alla med länken.",
  ...
  "terminal.connectTicket.csrfError": "PTY-anslutningsbiljetten avvisades vid ursprungs- eller CSRF-kontrollen. Kontrollera serverns CORS-konfiguration.",
  ...
  "debugBar.nav.tip": "Senast slutförda ruttövergång som berör en sessionssida, mätt från routerns start till första bildrutans rendering efter att övergången har slutförts.",
  ...
  "debugBar.long.tip": "Blockerad tid och antal långa uppgifter under de senaste 5 sekunderna. Längsta uppgift: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Längsta observerade inmatningsfördröjning under de senaste 5 sekunderna.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip": "Ungefärlig interaktionslängd under de senaste 5 sekunderna. Detta är INP-liknande, inte den officiella Web Vitals INP.",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Placera titelfältet och sessionsflikarna längst ned på skärmen på mobilen",
  "settings.general.row.showCustomAgents.title": "Visa agent",
  "settings.general.row.showCustomAgents.description": "Växla mellan agenter i inmatningsfältet. När alternativet är dolt används agenten Bygg som standard.",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "Visa skalverktygsdelar expanderade som standard på tidslinjen",
  ...
  "settings.general.row.newInterface.description": "Använd de nya flikarna och hemlayouten. Växla mellan layouter under en begränsad tid.",
  ...
  "settings.general.row.wayland.tooltip": "På Linux med skärmar som har olika uppdateringsfrekvens kan inbyggt Wayland-stöd vara stabilare.",
  ...
  "settings.general.notifications.agent.description": "Visa en systemavisering när agenten är klar eller behöver uppmärksamhet",
