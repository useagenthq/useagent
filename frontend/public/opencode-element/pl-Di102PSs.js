...
Kod: {{code}}`,
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  "provider.connect.opencodeZen.line2": "Za pomocą jednego klucza API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini i GLM, a także wielu innych.",
  ...
  "dialog.server.default.description": "Łącz się z tym serwerem przy uruchamianiu aplikacji zamiast uruchamiać serwer lokalny. Wymaga ponownego uruchomienia.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim OpenCode będzie mógł dodać serwer WSL",
  ...
  "wsl.onboarding.windowsRestartRequired": "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz OpenCode.",
  ...
  "dialog.project.edit.worktree.startup.description": "Uruchamiany po utworzeniu nowej przestrzeni roboczej (worktree).",
...
{{body}}`,
  ...
  "error.chain.mcpFailed": "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: OpenCode nie obsługuje jeszcze uwierzytelniania MCP.",
...
{{message}}`,
  ...
  "terminal.connectionLost.description": "Połączenie z terminalem zostało przerwane. Może się to zdarzyć podczas ponownego uruchamiania serwera.",
  ...
  "settings.general.row.showCustomAgents.description": "Umożliwiaj przełączanie agentów w edytorze wiadomości. Po ukryciu domyślnie używany jest agent Build.",
  ...
  "settings.general.row.newInterface.description": "Używaj nowych kart i układu strony głównej. Przez ograniczony czas możesz przełączać się między układami.",
  ...
  "settings.general.row.pinchZoom.description": "Zezwalaj na powiększanie gestem szczypania na gładziku lub przez przewijanie z wciśniętym klawiszem Ctrl",
  "settings.general.row.wayland.title": "Użyj natywnego protokołu Wayland",
  "settings.general.row.wayland.description": "Wyłącz awaryjne korzystanie z X11 w środowisku Wayland. Wymaga ponownego uruchomienia.",
  "settings.general.row.wayland.tooltip": "W systemie Linux z monitorami o różnej częstotliwości odświeżania natywny protokół Wayland może być stabilniejszy.",
  ...
  "settings.permissions.tool.edit.description": "Modyfikowanie plików, w tym edytowanie, zapisywanie, stosowanie łatek i edytowanie wielu plików",
  ...
  "debugBar.nav.tip": "Ostatnie zakończone przejście między trasami obejmujące stronę sesji, mierzone od uruchomienia routera do pierwszego odrysowania po ustabilizowaniu widoku.",
