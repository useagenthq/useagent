...
Kode: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "Pembaruan OpenCode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "Server WSL berhenti sebelum siap (kode={{code}} sinyal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Pemeriksaan kesehatan sidecar untuk {{distro}} kehabisan waktu setelah {{timeout}}ms",
  ...
  "provider.connect.apiKey.description": "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di OpenCode.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  "provider.connect.opencodeZen.line2": "Dengan satu kunci API, Anda akan mendapatkan akses ke model seperti Claude, GPT, Gemini, GLM dan lainnya.",
  ...
  "provider.connect.oauth.code.visit.suffix": " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di OpenCode.",
  ...
  "dialog.server.default.description": "Hubungkan ke server ini saat aplikasi diluncurkan, alih-alih memulai server lokal. Memerlukan mulai ulang.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Subsystem for Linux) diperlukan sebelum OpenCode dapat menambahkan server WSL",
  ...
  "help.tabs.sessions": "Mulai sesi baru di tab, atau buka sesi yang sudah ada dari proyek Anda. Buka tab baru saat Anda memulai sesuatu yang baru, lalu tutup setelah selesai.",
  "help.tabs.organize": "Membiarkan beberapa tab tetap terbuka memudahkan Anda mengatur sesi aktif. Ganti nama tab agar mudah diingat jika Anda berencana mempertahankannya.",
  ...
  "help.tabs.worktrees": "Desain baru belum mendukung Git Worktrees, tetapi dukungan tersebut akan segera hadir. Jika Anda ingin tetap menggunakan tata letak sebelumnya, Anda dapat beralih antartata letak di Pengaturan. Perlu diingat bahwa tata letak baru akan menjadi permanen dalam beberapa minggu.",
  ...
  "error.dev.rootNotFound": "Elemen root tidak ditemukan. Apakah Anda lupa menambahkannya ke index.html? Atau mungkin atribut id salah eja?",
...
{{body}}`,
  ...
  "error.chain.configDirectoryTypo": 'Direktori "{{dir}}" di {{path}} tidak valid. Ganti nama direktori menjadi "{{suggestion}}" atau hapus. Ini adalah kesalahan ketik yang umum.',
...
{{message}}`,
  ...
  "session.share.popover.description.unshared": "Bagikan sesi secara publik di web. Siapa pun dengan tautan dapat mengaksesnya.",
  ...
  "terminal.connectTicket.csrfError": "Tiket koneksi PTY ditolak oleh pemeriksaan asal atau CSRF. Periksa konfigurasi CORS server.",
  ...
  "debugBar.nav.tip": "Transisi rute terakhir yang mencapai halaman sesi, diukur sejak perute dimulai hingga render pertama setelah stabil.",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Tempatkan bilah judul dan tab sesi di bagian bawah layar pada perangkat seluler",
  "settings.general.row.showCustomAgents.title": "Tampilkan agen",
  "settings.general.row.showCustomAgents.description": "Beralih antaragen di penyusun. Saat disembunyikan, Agen Build digunakan sebagai bawaan.",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "Tampilkan bagian alat shell yang dibentangkan secara bawaan di linimasa",
  "settings.general.row.editToolPartsExpanded.title": "Bentangkan bagian alat edit",
  "settings.general.row.editToolPartsExpanded.description": "Tampilkan bagian alat edit, tulis, dan patch yang dibentangkan secara bawaan di linimasa",
  "settings.general.row.newInterface.title": "Tata letak baru",
  "settings.general.row.newInterface.badge": "Baru",
  "settings.general.row.newInterface.description": "Gunakan tab dan tata letak beranda baru. Beralihlah antartata letak untuk waktu terbatas.",
  ...
  "settings.general.row.wayland.tooltip": "Di Linux dengan monitor berlaju penyegaran berbeda, Wayland asli bisa lebih stabil.",
  ...
  "settings.general.notifications.agent.description": "Tampilkan notifikasi sistem saat agen selesai atau memerlukan perhatian",
