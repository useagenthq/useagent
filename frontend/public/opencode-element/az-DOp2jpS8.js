const e = {
  ...
  "desktop.recovery.unresponsive.detail": "Tətbiqi yenidən işə sala, jurnalları aça və ya gözləməyə davam edə bilərsiniz.",
...
Kod: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "OpenCode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL serveri işlək vəziyyətə gəlməzdən əvvəl dayandı (code={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "{{distro}} üçün sidecar sağlamlıq yoxlamasının {{timeout}}ms gözləmə müddəti bitdi",
  ...
  "provider.connect.apiKey.description": "Hesabınızı qoşmaq və OpenCode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  "provider.connect.opencodeZen.line2": "Tək bir API açarı ilə Claude, GPT, Gemini, GLM və daha çox modellərə giriş əldə edəcəksiniz.",
  ...
  "provider.connect.oauth.code.visit.suffix": " daxil olub hesabınızı qoşmaq və OpenCode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və OpenCode-da {{provider}} modellərindən istifadə edin.",
  ...
  "provider.custom.field.apiKey.description": "İstəyə bağlıdır. Autentifikasiyanı başlıqlar vasitəsilə idarə edirsinizsə, boş buraxın.",
  ...
  "dialog.server.default.description": "Tətbiq açıldıqda yerli server başlatmaq əvəzinə bu serverə qoşulun. Yenidən başlatma tələb olunur.",
  ...
  "wsl.onboarding.restartRequired": "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-un yenidən başlaması lazımdır.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "OpenCode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  ...
  "wsl.onboarding.windowsRestartRequired": "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra OpenCode-u yenidən açın.",
  ...
  "help.tabs.sessions": "Yeni sessiyanı tabda başladın və ya layihələrinizdən mövcud sessiyanı açın. Yeni işə başlayanda yeni tab açın, işi bitirdikdə isə onu bağlayın.",
  "help.tabs.organize": "Bir neçə tabı açıq saxlamaq aktiv sessiyalarınızı təşkil etməyi asanlaşdırır. Onları saxlamağı planlaşdırırsınızsa, tablara yadda qalan adlar verin.",
  "help.tabs.home": "Bütün sessiya və layihələrinizi yeni Ana səhifədə tapa bilərsiniz. Sessiyanı seçdikdə o, tabda açılır.",
  "help.tabs.persistence": "Tətbiqi yenidən açdıqda tablarınız açıq qalır.",
  "help.tabs.worktrees": "Yeni dizayn hələ Git Worktrees-i dəstəkləmir, lakin bu imkan tezliklə əlavə olunacaq. Əvvəlki tərtibatdan istifadə etməyə davam etmək istəyirsinizsə, Tənzimləmələrdə tərtibatlar arasında keçid edə bilərsiniz. Nəzərə alın ki, yeni tərtibat bir neçə həftədən sonra daimi olacaq.",
  ...
  "error.dev.rootNotFound": "Kök element tapılmadı. index.html-ə əlavə etməyi unutmusunuz? Yoxsa id atributu səhv yazılıb?",
...
{{body}}`,
  ...
  "error.chain.providerInitFailed": '"{{provider}}" provayderinin işə salınması uğursuz oldu. Giriş məlumatlarını və konfiqurasiyanı yoxlayın.',
  ...
  "error.chain.configDirectoryTypo": '{{path}} içindəki "{{dir}}" qovluğu etibarlı deyil. Qovluğu "{{suggestion}}" adına dəyişdirin və ya silin. Bu ümumi bir yazım xətasıdır.',
...
{{message}}`,
  ...
  "home.providerTip": "Claude, GPT, Gemini və s. daxil olmaqla, digər modellərdən istifadə etmək üçün 75+ provayderə qoşulun",
  ...
  "session.review.noSnapshot": "Snapshot izləmə konfiqurasiyada deaktiv edilib, ona görə də sessiya dəyişiklikləri əlçatan deyil",
  ...
  "session.share.popover.description.unshared": "Sessiyanı vebdə açıq paylaşın. Linkə sahib olan hər kəs daxil ola biləcək.",
  ...
  "terminal.connectTicket.csrfError": "PTY bağlantı bileti mənşə və ya CSRF yoxlaması zamanı rədd edildi. Serverin CORS konfiqurasiyasını yoxlayın.",
  ...
  "sidebar.gettingStarted.line2": "Claude, GPT, Gemini və s. kimi modellərdən istifadə etmək üçün istənilən provayderi qoşun.",
  ...
  "debugBar.nav.tip": "Sessiya səhifəsinə aid son tamamlanmış marşrut keçidi; marşrutlaşdırıcının başladığı andan keçid tamamlandıqdan sonrakı ilk göstərilməyədək ölçülür.",
  ...
  "debugBar.inp.tip": "Son 5 saniyədə təxmini qarşılıqlı əlaqə müddəti. Bu, rəsmi Web Vitals INP göstəricisi deyil, ona bənzər göstəricidir.",
  ...
  "settings.general.row.followup.description": "Sonrakı sorğuların dərhal yönləndirilməsini və ya növbədə gözləməsini seçin",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Başlıq çubuğunu və sessiya tablarını mobil cihazda ekranın aşağısına yerləşdirin",
  "settings.general.row.showCustomAgents.title": "Agenti göstər",
  "settings.general.row.showCustomAgents.description": "Mesaj sahəsində agentlər arasında keçid edin. Gizlədildikdə Build agenti seçilir.",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "Zaman xəttində shell alət hissələrini standart olaraq genişlədilmiş göstər",
  "settings.general.row.editToolPartsExpanded.title": "Redaktə alət hissələrini genişlət",
  "settings.general.row.editToolPartsExpanded.description": "Zaman xəttində redaktə, yazma və patch alət hissələrini standart olaraq genişlədilmiş göstər",
  "settings.general.row.newInterface.title": "Yeni tərtibat",
  "settings.general.row.newInterface.badge": "Yeni",
  "settings.general.row.newInterface.description": "Yeni tab və ana səhifə tərtibatından istifadə edin. Məhdud müddət ərzində tərtibatlar arasında keçid edin.",
  ...
  "settings.general.row.wayland.tooltip": "Qarışıq yeniləmə tezlikli monitorlu Linux-da nativ Wayland daha sabit ola bilər.",
  ...
  "settings.general.notifications.agent.description": "Agent tamamlandıqda və ya diqqət tələb etdikdə sistem bildirişi göstər",
