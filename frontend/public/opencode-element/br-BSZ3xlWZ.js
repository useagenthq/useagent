...
Código: {{code}}`,
  ...
  "dialog.server.default.description": "Conectar a este servidor na inicialização do aplicativo em vez de iniciar um servidor local. Requer reinicialização.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "O WSL (Windows Subsystem for Linux) é necessário para que o OpenCode possa adicionar um servidor WSL",
  ...
  "wsl.onboarding.windowsRestartRequired": "Reinicie o Windows para concluir a instalação do WSL e abra o OpenCode novamente.",
  ...
  "context.breakdown.note": 'Detalhamento aproximado dos tokens de entrada. "Outros" inclui definições de ferramentas e sobrecarga.',
...
{{message}}`,
  ...
  "settings.general.row.showCustomAgents.description": "Alternar entre agentes na área de composição. Quando oculto, usa o agente Build como padrão.",
  ...
  "settings.general.row.newInterface.description": "Use as novas abas e o layout da página inicial. Alterne entre os layouts por tempo limitado.",
  ...
  "settings.general.notifications.agent.description": "Mostrar notificação do sistema quando o agente concluir o trabalho ou precisar de atenção",
  ...
  "settings.general.sounds.agent.description": "Reproduzir som quando o agente concluir o trabalho ou precisar de atenção",
