const e = {
  ...
  "dialog.usageExceeded.freeTier.description": "Prenumerera på OpenCode Go för pålitlig tillgång till de bästa modellerna med öppen källkod, från 5 USD/månad.",
  ...
  "dialog.usageExceeded.accountRateLimit.description": "Användningsgräns nådd. För att fortsätta använda den här modellen nu, aktivera användning från ditt tillgängliga saldo",
