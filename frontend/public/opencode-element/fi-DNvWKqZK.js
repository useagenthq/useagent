const e = {
  ...
  "provider.connect.apiKey.description": "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenCodessa.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  "provider.connect.opencodeZen.line2": "Yhdellä API-avaimella pääset käyttämään malleja, kuten Claude, GPT, Gemini, GLM ja paljon muuta.",
  ...
  "provider.connect.oauth.code.visit.suffix": " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja OpenCodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja OpenCodessa.",
  ...
  "dialog.server.default.description": "Yhdistä tähän palvelimeen sovelluksen käynnistyksen yhteydessä paikallisen palvelimen käynnistämisen sijaan. Vaatii uudelleenkäynnistyksen.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin OpenCode voi lisätä WSL-palvelimen",
  ...
  "wsl.onboarding.windowsRestartRequired": "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten OpenCode uudelleen.",
  ...
  "context.breakdown.note": 'Syötetokenien arvioitu jakautuminen. "Muut" sisältää työkalumäärittelyt ja muun oheissisällön.',
  ...
  "error.dev.rootNotFound": "Juurielementtiä ei löydy. Unohditko lisätä sen index.html-tiedostoosi? Tai ehkä id-attribuutti on kirjoitettu väärin?",
  "error.serverSync.connectFailed": "Ei voitu muodostaa yhteyttä palvelimeen. Onko osoitteessa `{{url}}` käynnissä palvelin?",
...
{{body}}`,
  ...
  "error.chain.configJsonInvalidWithMessage": "Polun {{path}} määritystiedosto ei ole kelvollista JSON(C)-muotoa: {{message}}",
  "error.chain.configDirectoryTypo": 'Hakemisto "{{dir}}" polussa {{path}} ei kelpaa. Nimeä hakemisto uudelleen nimellä "{{suggestion}}" tai poista se. Tämä on yleinen kirjoitusvirhe.',
...
{{message}}`,
  ...
  "session.review.noSnapshot": "Tilannevedosten seuranta on poistettu käytöstä määrityksessä, joten istunnon muutokset eivät ole käytettävissä",
  ...
  "session.share.popover.description.shared": "Tämä istunto on julkinen verkossa. Se on kaikkien linkin saaneiden käytettävissä.",
  "session.share.popover.description.unshared": "Jaa istunto julkisesti verkossa. Se on kaikkien linkin saaneiden käytettävissä.",
  ...
  "terminal.connectTicket.csrfError": "PTY-yhteyslippu hylättiin alkuperä- tai CSRF-tarkistuksessa. Tarkista palvelimen CORS-määritys.",
  ...
  "sidebar.gettingStarted.line2": "Yhdistä mikä tahansa palveluntarjoaja käyttääksesi malleja, mm. Claude, GPT, Gemini jne.",
  ...
  "debugBar.nav.tip": "Viimeisin valmis reittisiirtymä, joka koskee istuntosivua, mitattuna reitityksen alusta ensimmäiseen piirtoon siirtymän valmistumisen jälkeen.",
  ...
  "debugBar.inp.tip": "Vuorovaikutuksen arvioitu kesto viimeisen 5 sekunnin ajalta. Tämä on INP-tyyppinen, ei virallinen Web Vitals INP.",
  ...
  "settings.general.row.showNavigation.description": "Näytä taaksepäin- ja eteenpäin-painikkeet työpöydän otsikkorivillä",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Sijoita otsikkopalkki ja istuntovälilehdet mobiililaitteen näytön alareunaan",
  "settings.general.row.showCustomAgents.title": "Näytä agentin valinta",
  "settings.general.row.showCustomAgents.description": "Vaihda agenttien välillä viestikentässä. Kun valinta on piilotettu, Build-agenttia käytetään oletuksena.",
  ...
  "settings.general.row.shellToolPartsExpanded.description": "Näytä shell-työkalun osat oletuksena laajennettuina aikajanalla",
  "settings.general.row.editToolPartsExpanded.title": "Laajenna muokkaustyökalun osat",
  "settings.general.row.editToolPartsExpanded.description": "Näytä muokkaus-, kirjoitus- ja paikkaustyökalun osat oletusarvoisesti laajennettuina aikajanalla",
  "settings.general.row.newInterface.title": "Uusi asettelu",
  "settings.general.row.newInterface.badge": "Uusi",
  "settings.general.row.newInterface.description": "Käytä uusia välilehtiä ja etusivun asettelua. Vaihda asettelujen välillä rajoitetun ajan.",
  ...
  "settings.general.row.wayland.tooltip": "Linuxissa alkuperäinen Wayland voi olla vakaampi käytettäessä näyttöjä, joiden virkistystaajuudet eroavat toisistaan.",
  ...
  "settings.providers.custom.description": "Lisää OpenAI-yhteensopiva palveluntarjoaja perus-URL-osoitteen perusteella.",
  ...
  "settings.permissions.tool.edit.description": "Tiedostojen muokkaaminen, mukaan lukien muokkaus-, kirjoitus- ja paikkaustoiminnot",
...
Koodi: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "OpenCoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL-palvelin sulkeutui ennen toimintavalmiutta (koodi={{code}} signaali={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Jakelun {{distro}} sivuprosessin kuntotarkistus aikakatkaistiin {{timeout}} ms:n jälkeen",
  ...
  "help.tabs.sessions": "Aloita uusi istunto välilehdessä tai avaa olemassa oleva istunto mistä tahansa projektistasi. Avaa uusi välilehti, kun aloitat jotain uutta, ja sulje se, kun olet valmis.",
  "help.tabs.organize": "Muutaman välilehden pitäminen avoinna helpottaa aktiivisten istuntojen järjestämistä. Nimeä välilehdet helposti muistettaviksi, jos aiot pitää ne avoinna.",
  "help.tabs.home": "Kaikki istuntosi ja projektisi ovat uudessa etusivunäkymässä. Istunnon valitseminen avaa sen välilehteen.",
  "help.tabs.persistence": "Kun avaat sovelluksen uudelleen, välilehtesi ovat yhä avoinna.",
  "help.tabs.worktrees": "Uusi ulkoasu ei vielä tue Git-työpuita, mutta tuki on tulossa pian. Jos haluat jatkaa aiemman ulkoasun käyttöä, voit vaihtaa ulkoasua asetuksissa. Huomaa kuitenkin, että uudesta ulkoasusta tulee pysyvä muutaman viikon kuluttua."
};
export {
  e as dict
};
