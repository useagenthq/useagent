...
Kod: {{code}}`,
  ...
  "provider.connect.apiKey.description": "{{provider}} hesabınızı bağlamak ve OpenCode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix": " gidin; ardından hesabınızı bağlayarak OpenCode'da {{provider}} modellerini kullanın.",
  ...
  "provider.custom.field.apiKey.description": "İsteğe bağlı. Kimlik doğrulamayı başlıklarla yönetiyorsanız boş bırakın.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "OpenCode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
...
{{body}}`,
  ...
  "error.chain.mcpFailed": 'MCP sunucusu "{{name}}" çalıştırılamadı. Not: OpenCode henüz MCP kimlik doğrulamasını desteklemiyor.',
...
{{message}}`,
  ...
  "settings.general.row.followup.description": "Takip istemlerinin hemen yönlendirilmesini mi yoksa sırada beklemesini mi istediğinizi seçin",
  ...
  "settings.general.row.showCustomAgents.description": "Düzenleyicide ajanlar arasında geçiş yapın. Gizlendiğinde varsayılan olarak Build ajanı kullanılır.",
  ...
  "settings.general.row.newInterface.description": "Yeni sekmeleri ve ana sayfa düzenini kullanın. Sınırlı bir süre boyunca düzenler arasında geçiş yapabilirsiniz.",
  ...
  "settings.general.row.wayland.tooltip": "Farklı yenileme hızlarına sahip monitörlerin kullanıldığı Linux sistemlerinde yerel Wayland daha kararlı olabilir.",
