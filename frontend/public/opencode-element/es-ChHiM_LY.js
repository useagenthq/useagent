...
Código: {{code}}`,
  ...
  "provider.connect.apiKey.description": "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en OpenCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en OpenCode.",
  ...
  "dialog.server.default.description": "Conectar a este servidor al iniciar la aplicación en lugar de iniciar un servidor local. Requiere reiniciar.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Se necesita WSL (Subsistema de Windows para Linux) para que OpenCode pueda añadir un servidor WSL",
  ...
  "wsl.onboarding.windowsRestartRequired": "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir OpenCode.",
...
{{message}}`,
  ...
  "settings.general.row.showCustomAgents.description": "Cambiar de agente en el editor. Si se oculta, se usa el agente Build de forma predeterminada.",
  ...
  "settings.general.row.newInterface.description": "Usa las nuevas pestañas y el diseño de la página de inicio. Durante un tiempo limitado, puedes cambiar entre los diseños.",
  ...
  "settings.general.row.pinchZoom.description": "Permitir ampliar con el gesto de pellizco del panel táctil y con Ctrl + desplazamiento",
  ...
  "debugBar.nav.tip": "Última transición de ruta completada que afecta a una página de sesión, medida desde el inicio del enrutador hasta el primer renderizado tras estabilizarse.",
