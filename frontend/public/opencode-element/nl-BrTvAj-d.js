...
Code: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "De OpenCode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "WSL-server is afgesloten voordat deze gereed was (code={{code}} signaal={{signal}}){{output}}",
  ...
  "provider.connect.apiKey.description": "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in OpenCode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix": " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in OpenCode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in OpenCode te gebruiken.",
  ...
  "dialog.server.default.description": "Maak verbinding met deze server bij het starten van de app in plaats van een lokale server te starten. Vereist opnieuw opstarten.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows-subsysteem voor Linux) is vereist voordat OpenCode een WSL-server kan toevoegen",
  ...
  "wsl.onboarding.windowsRestartRequired": "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens OpenCode opnieuw.",
  ...
  "help.tabs.sessions": "Start een nieuwe sessie in een tabblad of open een bestaande sessie vanuit een van je projecten. Open een nieuw tabblad wanneer je aan iets nieuws begint en sluit het wanneer je klaar bent.",
  "help.tabs.organize": "Met enkele geopende tabbladen kun je je actieve sessies gemakkelijker organiseren. Geef tabbladen een herkenbare naam als je ze geopend wilt houden.",
  "help.tabs.home": "Je vindt al je sessies en projecten op het nieuwe startscherm. Wanneer je een sessie selecteert, wordt deze in een tabblad geopend.",
  "help.tabs.persistence": "Wanneer je de app opnieuw opent, zijn je tabbladen nog steeds geopend.",
  "help.tabs.worktrees": "Het nieuwe ontwerp ondersteunt Git-worktrees nog niet, maar die ondersteuning komt binnenkort. Als je liever de vorige lay-out blijft gebruiken, kun je in Instellingen tussen de lay-outs schakelen. Houd er rekening mee dat de nieuwe lay-out over enkele weken permanent wordt.",
  ...
  "dialog.project.edit.worktree.startup.description": "Wordt uitgevoerd nadat een nieuwe werkruimte (worktree) is aangemaakt.",
  ...
  "context.breakdown.note": 'Geschatte uitsplitsing van invoertokens. "Overig" omvat gereedschapsdefinities en overhead.',
  ...
  "toast.session.unshare.failed.description": "Er is een fout opgetreden bij het ongedaan maken van het delen van de sessie",
  ...
  "error.dev.rootNotFound": "Root-element niet gevonden. Ben je vergeten het toe te voegen aan je index.html? Of is het id-attribuut misschien verkeerd gespeld?",
...
{{body}}`,
  ...
  "error.chain.providerInitFailed": 'Kan provider "{{provider}}" niet initialiseren. Controleer de inloggegevens en configuratie.',
  ...
  "error.chain.configDirectoryTypo": 'De map "{{dir}}" in {{path}} is ongeldig. Hernoem de map naar "{{suggestion}}" of verwijder deze. Dit is een veelvoorkomende typefout.',
...
{{message}}`,
  ...
  "home.providerTip": "Maak verbinding met meer dan 75 providers om andere modellen te gebruiken, waaronder Claude, GPT, Gemini, enz.",
  ...
  "session.review.noSnapshot": "Het bijhouden van momentopnamen is uitgeschakeld in de configuratie, dus sessiewijzigingen zijn niet beschikbaar",
  ...
  "session.share.popover.description.shared": "Deze sessie is openbaar op internet. Iedereen met de link heeft toegang.",
  "session.share.popover.description.unshared": "Deel de sessie openbaar op internet. Iedereen met de link krijgt toegang.",
  ...
  "terminal.connectionLost.description": "De terminalverbinding is onderbroken. Dit kan gebeuren wanneer de server opnieuw wordt opgestart.",
  "terminal.connectTicket.csrfError": "PTY-verbindingsticket geweigerd door oorsprongs- of CSRF-controles. Controleer de CORS-configuratie van de server.",
  ...
  "debugBar.nav.tip": "Laatst voltooide routenavigatie naar of binnen een sessiepagina, gemeten vanaf het starten van de router tot de eerste render nadat de navigatie is voltooid.",
  ...
  "debugBar.inp.tip": "Geschatte interactieduur gedurende de afgelopen 5 seconden. Dit is INP-achtig, niet de officiële Web Vitals INP.",
  ...
  "settings.general.row.colorScheme.description": "Kies of OpenCode het systeemthema, het lichte thema of het donkere thema gebruikt",
  ...
  "settings.general.row.followup.description": "Kies of vervolgprompts de sessie direct bijsturen of in een wachtrij wachten",
  ...
  "settings.general.row.showNavigation.description": "Toon de knoppen Vorige en Volgende in de titelbalk van de desktop-app",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Plaats de titelbalk en sessietabbladen onderaan het scherm op mobiel",
  "settings.general.row.showCustomAgents.title": "Toon agent",
  "settings.general.row.showCustomAgents.description": "Schakel tussen agenten in het invoerveld. Indien verborgen wordt standaard de Build-agent gebruikt.",
  "settings.general.row.reasoningSummaries.title": "Toon redeneeroverzichten",
  "settings.general.row.reasoningSummaries.description": "Geef samenvattingen van modelredeneringen weer in de tijdlijn",
  "settings.general.row.shellToolPartsExpanded.title": "Shelltoolonderdelen uitvouwen",
  "settings.general.row.shellToolPartsExpanded.description": "Toon shelltoolonderdelen standaard uitgevouwen in de tijdlijn",
  "settings.general.row.editToolPartsExpanded.title": "Bewerkingstoolonderdelen uitvouwen",
  "settings.general.row.editToolPartsExpanded.description": "Toon bewerkings-, schrijf- en patchtoolonderdelen standaard uitgevouwen in de tijdlijn",
  "settings.general.row.newInterface.title": "Nieuwe lay-out",
  "settings.general.row.newInterface.badge": "Nieuw",
  "settings.general.row.newInterface.description": "Gebruik de nieuwe tabbladen en home-indeling. Wissel gedurende een beperkte tijd tussen lay-outs.",
  ...
  "settings.general.row.pinchZoom.description": "Sta knijp- en Ctrl-scroll-bewegingen op het trackpad toe om in te zoomen",
  ...
  "settings.general.row.wayland.tooltip": "Op Linux met monitoren met verschillende vernieuwingsfrequenties kan native Wayland stabieler zijn.",
  ...
  "settings.general.notifications.agent.description": "Toon systeemmelding wanneer de agent klaar is of aandacht nodig heeft",
  ...
  "settings.permissions.tool.edit.description": "Wijzig bestanden, inclusief bewerkingen, schrijfbewerkingen en patches",
  ...
  "workspace.reset.note": "Hierdoor wordt de werkruimte opnieuw ingesteld zodat deze overeenkomt met de standaardbranch."
};
export {
  e as dict
};
