...
Kode: {{code}}`,
  ...
  "provider.connect.apiKey.description": "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenCode.",
  ...
  "provider.custom.field.apiKey.description": "Valgfritt. La stå tomt hvis du administrerer autentisering via HTTP-hoder.",
  ...
  "context.breakdown.note": 'Omtrentlig fordeling av inndatatokener. "Annet" inkluderer verktøydefinisjoner og overhead.',
  ...
  "error.dev.rootNotFound": "Rotelement ikke funnet. Glemte du å legge det til i index.html? Eller kanskje id-attributtet er feilstavet?",
...
{{message}}`,
  ...
  "settings.general.row.colorScheme.description": "Velg om OpenCode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  ...
  "settings.general.row.wayland.tooltip": "På Linux med skjermer med blandet oppdateringsfrekvens kan direkte Wayland-støtte være mer stabilt.",
  ...
  "debugBar.nav.tip": "Siste fullførte ruteovergang som berører en sesjonsside, målt fra ruterstart til første gjengivelse etter at den har roet seg.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Subsystem for Linux) kreves før OpenCode kan legge til en WSL-server",
  ...
  "wsl.onboarding.windowsRestartRequired": "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter OpenCode på nytt.",
  ...
  "settings.general.row.showCustomAgents.description": "Bytt mellom agenter i skrivefeltet. Når velgeren er skjult, brukes Build-agenten som standard.",
  "settings.general.row.newInterface.title": "Nytt oppsett",
  "settings.general.row.newInterface.badge": "Ny",
  "settings.general.row.newInterface.description": "Bruk de nye fanene og startsidens oppsett. I en begrenset periode kan du bytte mellom oppsettene.",
