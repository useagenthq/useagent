const e = {
  ...
  "provider.connect.apiKey.description": "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i OpenCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i OpenCode.",
  ...
  "dialog.server.default.description": "Opret forbindelse til denne server, når appen starter, i stedet for at starte en lokal server. Kræver genstart.",
  ...
  "wsl.onboarding.windowsRestartRequired": "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter OpenCode igen.",
...
{{message}}`,
  ...
  "settings.general.row.newInterface.description": "Brug de nye faner og startsidens layout. Du kan skifte mellem layoutene i en begrænset periode.",
  ...
  "settings.general.row.wayland.tooltip": "På Linux med skærme med forskellige opdateringshastigheder kan indbygget Wayland være mere stabilt.",
  ...
  "settings.permissions.tool.edit.description": "Rediger filer, herunder med redigeringer, skrivning, patches og multiredigeringer",
