...
Code : {{code}}`,
  ...
  "provider.connect.apiKey.description": "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans OpenCode.",
  ...
  "provider.connect.oauth.code.visit.suffix": " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans OpenCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans OpenCode.",
  ...
  "context.breakdown.note": `Répartition approximative des jetons d'entrée. "Autre" inclut les définitions d'outils et les données annexes.`,
  ...
  "toast.update.description": "Une nouvelle version d'OpenCode ({{version}}) est maintenant disponible pour installation.",
...
{{body}}`,
  ...
  "error.chain.mcpFailed": `Le serveur MCP "{{name}}" a échoué. Notez qu'OpenCode ne prend pas encore en charge l'authentification MCP.`,
...
{{message}}`,
  ...
  "session.share.popover.description.unshared": "Rendre la session publique sur le Web. Elle sera accessible à toute personne disposant du lien.",
  ...
  "sidebar.gettingStarted.line1": "OpenCode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.followup.description": "Choisissez si les messages de suivi orientent immédiatement l'agent ou sont placés dans une file d'attente",
  ...
  "settings.general.row.showNavigation.description": "Afficher les boutons précédent et suivant dans la barre de titre de l'application de bureau",
  ...
  "settings.general.row.showTerminal.description": "Afficher le bouton du terminal dans la barre de titre de l'application de bureau",
  ...
  "settings.general.row.newInterface.description": "Utilisez les nouveaux onglets et la mise en page de l'accueil. Vous pouvez alterner entre les mises en page pendant une durée limitée.",
  ...
  "settings.permissions.tool.edit.description": "Modifier des fichiers, notamment au moyen des outils edit, write et patch",
  ...
  "debugBar.inp.tip": "Durée approximative d'interaction au cours des 5 dernières secondes. Il s'agit d'une mesure similaire à l'INP, et non de l'INP officiel des Web Vitals.",
