const e = {
  ...
  "provider.connect.apiKey.description": "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in OpenCode.",
  ...
  "provider.connect.opencodeZen.line1": "OpenCode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.opencodeZen.line2": "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  ...
  "provider.connect.oauth.code.visit.suffix": " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in OpenCode.",
  ...
  "provider.custom.field.apiKey.description": "Opzionale. Lascia vuoto se gestisci l'autenticazione tramite intestazioni.",
  ...
  "dialog.server.default.description": "Connettiti a questo server all'avvio dell'app invece di avviare un server locale. Richiede il riavvio.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Sottosistema Windows per Linux) è necessario prima che OpenCode possa aggiungere un server WSL",
  ...
  "wsl.onboarding.windowsRestartRequired": "Riavvia Windows per completare l'installazione WSL, quindi riapri OpenCode.",
  ...
  "help.tabs.sessions": "Avvia una nuova sessione in una scheda oppure apri una sessione esistente da uno dei tuoi progetti. Apri una nuova scheda quando inizi qualcosa di nuovo e chiudila quando hai finito.",
  "help.tabs.organize": "Tenere aperte alcune schede semplifica l'organizzazione delle sessioni attive. Se prevedi di conservarle, rinominale con un nome facile da ricordare.",
  "help.tabs.home": "Troverai tutte le sessioni e i progetti nella nuova schermata Home. Quando selezioni una sessione, questa si apre in una scheda.",
  "help.tabs.persistence": "Quando riapri l'app, le schede sono ancora aperte.",
  "help.tabs.worktrees": "Il nuovo design non supporta ancora Git Worktrees, ma il supporto arriverà presto. Se preferisci continuare a utilizzare la disposizione precedente, puoi passare da una disposizione all'altra nelle Impostazioni. Tieni presente che la nuova disposizione diventerà permanente tra alcune settimane.",
  ...
  "dialog.project.edit.worktree.startup.description": "Viene eseguito dopo la creazione di una nuova area di lavoro (worktree).",
  ...
  "context.breakdown.note": 'Ripartizione approssimativa dei token di input. "Altro" include le definizioni degli strumenti e i dati aggiuntivi.',
  ...
  "error.dev.rootNotFound": "Elemento radice non trovato. Hai dimenticato di aggiungerlo al tuo index.html? O forse l'attributo id è stato scritto in modo errato?",
...
{{body}}`,
  ...
  "error.chain.mcpFailed": `Il server MCP "{{name}}" non ha funzionato. Nota: OpenCode non supporta ancora l'autenticazione MCP.`,
  "error.chain.providerAuthFailed": "Autenticazione del provider non riuscita ({{provider}}): {{message}}",
  "error.chain.providerInitFailed": 'Impossibile inizializzare il provider "{{provider}}". Controlla credenziali e configurazione.',
  ...
  "error.chain.configDirectoryTypo": 'La directory "{{dir}}" in {{path}} non è valida. Rinominare la directory in "{{suggestion}}" o rimuoverla. Questo è un errore di battitura comune.',
...
{{message}}`,
  ...
  "session.share.popover.description.shared": "Questa sessione è pubblica sul web. È accessibile a chiunque abbia il collegamento.",
  "session.share.popover.description.unshared": "Condividi la sessione pubblicamente sul web. Sarà accessibile a chiunque abbia il collegamento.",
  ...
  "terminal.connectionLost.description": "La connessione del terminale è stata interrotta. Ciò può verificarsi al riavvio del server.",
  "terminal.connectTicket.csrfError": "Il ticket di connessione PTY è stato rifiutato dai controlli sull'origine o CSRF. Verifica la configurazione CORS del server.",
  ...
  "debugBar.nav.tip": "Ultima transizione completata relativa a una pagina di sessione, misurata dall'avvio del router fino al primo rendering dopo la stabilizzazione.",
  ...
  "debugBar.long.tip": "Tempo bloccato e numero di attività lunghe negli ultimi 5 secondi. Attività più lunga: {{max}}.",
  "debugBar.delay.label": "DELAY",
  "debugBar.delay.tip": "Peggiore ritardo di risposta all'input osservato negli ultimi 5 secondi.",
  "debugBar.inp.label": "INP",
  "debugBar.inp.tip": "Durata approssimativa dell'interazione negli ultimi 5 secondi. È una misura simile a INP, non l'INP ufficiale di Web Vitals.",
  ...
  "settings.general.row.showNavigation.description": "Mostra i pulsanti Avanti e Indietro nella barra del titolo del desktop",
  "settings.general.row.showSearch.title": "Palette dei comandi",
  "settings.general.row.showSearch.description": "Mostra il pulsante di ricerca e della palette dei comandi nella barra del titolo",
  ...
  "settings.general.row.mobileTitlebarBottom.description": "Posiziona la barra del titolo e le schede della sessione nella parte inferiore dello schermo sul dispositivo mobile",
  "settings.general.row.showCustomAgents.title": "Mostra agente",
  "settings.general.row.showCustomAgents.description": "Passa da un agente all'altro nel campo di composizione. Se nascosto, viene usato l'agente Build.",
  "settings.general.row.reasoningSummaries.title": "Mostra riassunti del ragionamento",
  "settings.general.row.reasoningSummaries.description": "Visualizza i riepiloghi del ragionamento del modello nella sequenza temporale",
  "settings.general.row.shellToolPartsExpanded.title": "Espandi le parti dello strumento Shell",
  "settings.general.row.shellToolPartsExpanded.description": "Mostra le parti dello strumento Shell espanse per impostazione predefinita nella sequenza temporale",
  "settings.general.row.editToolPartsExpanded.title": "Espandi le parti dello strumento di modifica",
  "settings.general.row.editToolPartsExpanded.description": "Mostra le parti degli strumenti di modifica, scrittura e patch espanse per impostazione predefinita nella sequenza temporale",
  "settings.general.row.newInterface.title": "Nuova disposizione",
  "settings.general.row.newInterface.badge": "Nuovo",
  "settings.general.row.newInterface.description": "Utilizza le nuove schede e il layout della home page. Passa da un layout all'altro per un periodo limitato.",
  ...
  "settings.general.row.pinchZoom.description": "Consenti i gesti di pizzicamento del trackpad e di scorrimento Ctrl per eseguire lo zoom",
  ...
  "settings.general.row.wayland.tooltip": "Su Linux con monitor dalle diverse frequenze di aggiornamento, Wayland nativo può essere più stabile.",
  ...
  "settings.general.notifications.permissions.description": "Mostra la notifica di sistema quando è richiesta un'autorizzazione",
  ...
  "settings.permissions.description": "Controlla quali strumenti può utilizzare il server per impostazione predefinita.",
...
Codice: {{code}}`,
  ...
  "desktop.wsl.error.updateVersion": "L'aggiornamento di OpenCode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
  ...
  "desktop.wsl.error.serverExitedBeforeHealthy": "Il server WSL si è chiuso prima di diventare operativo (code={{code}} signal={{signal}}){{output}}",
  "desktop.wsl.error.healthTimeout": "Il controllo dello stato del sidecar per {{distro}} ha superato il tempo limite di {{timeout}}ms",
