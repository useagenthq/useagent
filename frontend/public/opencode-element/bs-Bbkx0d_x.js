...
Kod: {{code}}`,
  ...
  "provider.connect.apiKey.description": "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenCode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix": " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenCode-u.",
  ...
  "dialog.server.default.description": "Poveži se na ovaj server pri pokretanju aplikacije umjesto pokretanja lokalnog servera. Potrebno je ponovo pokrenuti aplikaciju.",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windows Subsystem for Linux) je potreban da bi OpenCode mogao dodati WSL server",
  ...
  "wsl.onboarding.windowsRestartRequired": "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori OpenCode.",
  ...
  "context.breakdown.note": 'Približna raspodjela ulaznih tokena. "Ostalo" uključuje definicije alata i dodatno opterećenje.',
...
{{message}}`,
  ...
  "home.providerTip": "Poveži se s više od 75 provajdera da koristiš druge modele, uključujući Claude, GPT, Gemini i druge",
  ...
  "terminal.connectionLost.description": "Veza s terminalom je prekinuta. Ovo se može desiti kada se server ponovo pokrene.",
  ...
  "settings.general.row.newInterface.description": "Koristi nove kartice i raspored početne stranice. Ograničeno vrijeme možeš se prebacivati između rasporeda.",
  ...
  "settings.general.row.wayland.description": "Onemogući rezervni X11 način rada na Waylandu. Zahtijeva ponovno pokretanje.",
  ...
  "settings.permissions.tool.edit.description": "Mijenjanje datoteka, uključujući uređivanje, pisanje, zakrpe i višestruke izmjene",
