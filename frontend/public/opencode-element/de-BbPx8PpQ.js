const e = {
  ...
  "provider.connect.apiKey.description": "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in OpenCode zu nutzen.",
  ...
  "dialog.server.default.description": "Beim App-Start mit diesem Server verbinden, anstatt einen lokalen Server zu starten. Ein Neustart ist erforderlich.",
  ...
  "wsl.onboarding.windowsRestartRequired": "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann OpenCode erneut.",
...
{{message}}`,
  ...
  "home.providerTip": "OpenCode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "settings.general.row.colorScheme.description": "Wählen Sie, ob OpenCode dem System-, hellen oder dunklen Thema folgt",
  ...
  "settings.general.row.followup.description": "Wählen Sie, ob Folgeeingaben die laufende Sitzung sofort steuern oder in einer Warteschlange warten",
  ...
  "settings.general.row.newInterface.description": "Verwenden Sie die neuen Tabs und das Startseitenlayout. Für begrenzte Zeit können Sie zwischen den Layouts wechseln.",
  ...
  "debugBar.nav.tip": "Letzter abgeschlossener Routenübergang zu einer Sitzungsseite, gemessen vom Start des Routers bis zum ersten Rendering nach Abschluss des Übergangs.",
