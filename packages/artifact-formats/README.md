...
render helpers remain internal implementation details.

## Current Contract

| Format | Create/export | Import/extract | Notes |
|---|---:|---:|---|
| DOCX | Yes | Text only | Renders paragraph text and extracts raw text. |
...
| PDF | Yes | No | Renders readable text PDFs; uploaded PDF extraction is not claimed yet. |
